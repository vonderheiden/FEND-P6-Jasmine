...
$(function() {
    ...
    describe('The menu', function() {
        ...
        /* Test 5 validates that the menu shows/hides when the icon is clicked. Assumption is that the menu is hidden by default. The first test expectation is that on clicking the menu icon it should become visible. The second test expectation is that when it is clicked again it should hide. */
   ...
   describe('Initial Entries', function() {
        /*Test 6 validates that there is at least one '.entry' element in the '.feed' container when the asynchronous loadFeed function is called and completed. The setTimeout function in the beforeEach function delays to populate the '.feed' element. */
        var retFeed;
    ...
    describe('New Feed Selection', function() {
        ...
        The loadFeed function has a second argument, which is a callback, and it runs the code block when the async request is complete.
        When done() is called, it means the test expectations can be evaluated and is ready to run.
